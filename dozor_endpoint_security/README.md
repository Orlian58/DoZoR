...
2) Для работы антивирусного сканера необходимо добавить yara правила.
3) Установить путь до файла с конфигурацией dozor.conf в вашей системе(по умолчанию: conf/dozor.conf) в файле flask-api/app/app.py (PATH_TO_CONF)
